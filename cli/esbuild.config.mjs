/**
 * esbuild configuration for building the mnm CLI for npm.
 *
 * Bundles all workspace packages (@mnm/*) into a single file.
...
// to npm and resolved at runtime (e.g. @mnm/server uses dynamic import).
