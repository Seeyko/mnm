...
import { buildProjectMentionHref, parseProjectMentionHref } from "@mnm/shared";
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("mnm-project-mention-chip");
      ...
      link.classList.add("mnm-project-mention-chip");
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("mnm-mdxeditor", !bordered && "mnm-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "mnm-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
