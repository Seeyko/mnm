...
// Canonical type lives in @mnm/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@mnm/adapter-utils";
import type { CreateConfigValues } from "@mnm/adapter-utils";
...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local"]);
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        MNM_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
