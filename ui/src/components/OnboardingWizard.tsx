...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/mnm/companies/blob/main/default/ceo/AGENTS.md](https://github.com/mnm/companies/blob/main/default/ceo/AGENTS.md)
