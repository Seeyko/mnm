...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@mnm/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@mnm/adapter-utils").TranscriptEntry[];
