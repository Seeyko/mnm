...
--> statement-breakpoint
CREATE INDEX "workflow_instances_company_status_idx" ON "workflow_instances" USING btree ("company_id","status");
--> statement-breakpoint
CREATE INDEX "workflow_instances_company_project_idx" ON "workflow_instances" USING btree ("company_id","project_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "stage_instances_workflow_order_idx" ON "stage_instances" USING btree ("workflow_instance_id","stage_order");
--> statement-breakpoint
CREATE INDEX "stage_instances_company_status_idx" ON "stage_instances" USING btree ("company_id","status");
