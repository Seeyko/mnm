...
--> statement-breakpoint
CREATE TABLE "credential_proxy_rules" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"company_id" uuid NOT NULL,
	"name" text NOT NULL,
...
CREATE INDEX "audit_events_company_actor_idx" ON "audit_events" USING btree ("company_id","actor_id","actor_type");--> statement-breakpoint
CREATE INDEX "audit_events_company_action_idx" ON "audit_events" USING btree ("company_id","action");--> statement-breakpoint
CREATE INDEX "audit_events_company_target_idx" ON "audit_events" USING btree ("company_id","target_type","target_id");--> statement-breakpoint
CREATE INDEX "audit_events_company_severity_idx" ON "audit_events" USING btree ("company_id","severity","created_at");--> statement-breakpoint
...
CREATE INDEX "automation_cursors_company_level_idx" ON "automation_cursors" USING btree ("company_id","level");--> statement-breakpoint
CREATE INDEX "chat_channels_company_agent_idx" ON "chat_channels" USING btree ("company_id","agent_id");--> statement-breakpoint
CREATE INDEX "chat_channels_company_status_idx" ON "chat_channels" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "chat_channels_heartbeat_run_idx" ON "chat_channels" USING btree ("heartbeat_run_id");--> statement-breakpoint
...
CREATE INDEX "chat_messages_sender_idx" ON "chat_messages" USING btree ("sender_id","sender_type");--> statement-breakpoint
CREATE INDEX "container_instances_company_status_idx" ON "container_instances" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "container_instances_company_agent_idx" ON "container_instances" USING btree ("company_id","agent_id");--> statement-breakpoint
CREATE INDEX "container_instances_docker_container_idx" ON "container_instances" USING btree ("docker_container_id");--> statement-breakpoint
CREATE INDEX "container_instances_profile_idx" ON "container_instances" USING btree ("profile_id");--> statement-breakpoint
...
CREATE INDEX "container_profiles_company_idx" ON "container_profiles" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "credential_proxy_rules_company_enabled_idx" ON "credential_proxy_rules" USING btree ("company_id","enabled");--> statement-breakpoint
CREATE INDEX "credential_proxy_rules_company_pattern_idx" ON "credential_proxy_rules" USING btree ("company_id","secret_pattern");--> statement-breakpoint
CREATE INDEX "import_jobs_company_status_idx" ON "import_jobs" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "import_jobs_company_source_idx" ON "import_jobs" USING btree ("company_id","source");--> statement-breakpoint
CREATE INDEX "import_jobs_company_created_idx" ON "import_jobs" USING btree ("company_id","created_at");--> statement-breakpoint
...
CREATE INDEX "project_memberships_company_project_idx" ON "project_memberships" USING btree ("company_id","project_id");--> statement-breakpoint
...
CREATE INDEX "sso_configurations_company_enabled_idx" ON "sso_configurations" USING btree ("company_id","enabled");