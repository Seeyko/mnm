...
import { extractProjectMentionIds } from "@mnm/shared";
...
const TERMINAL_HEARTBEAT_RUN_STATUSES = new Set(["succeeded", "failed", "cancelled", "timed_out", "interrupted"]);
...
export function issueService(db: Db) {
  ...
  return {
    ...
    addComment: async (issueId: string, body: string, actor: { agentId?: string; userId?: string }, contentBlocks?: unknown) => {
