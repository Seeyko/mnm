...
const DEFERRED_WAKE_CONTEXT_KEY = "_mnmWakeContext";
const startLocksByAgent = new Map<string, Promise<void>>();
const REPO_ONLY_CWD_SENTINEL = "/__mnm_repo_only__";
...
export function heartbeatService(db: Db) {
  ...
  async function executeRun(runId: string) {
    ...
    context.mnmWorkspaces = resolvedWorkspace.workspaceHints;
