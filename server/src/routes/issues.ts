    ...
    void (async () => {
      ...
      if (assigneeChanged && issue.assigneeAgentId && issue.status !== "backlog") {
        wakeups.set(issue.assigneeAgentId, {
          ...
          requestedByActorType: actor.actorType,
          requestedByActorId: actor.actorId,
          contextSnapshot: { issueId: issue.id, issueTitle: issue.title, issueDescription: issue.description, source: "issue.update" },
        });
      }
      ...
      if (!assigneeChanged && statusChangedFromBacklog && issue.assigneeAgentId) {
        wakeups.set(issue.assigneeAgentId, {
          ...
          requestedByActorType: actor.actorType,
          requestedByActorId: actor.actorId,
          contextSnapshot: { issueId: issue.id, issueTitle: issue.title, issueDescription: issue.description, source: "issue.status_change" },
        });
      }
    ...
    if (
      ...
      void heartbeat
        .wakeup(req.body.agentId, {
          ...
          requestedByActorType: actor.actorType,
          requestedByActorId: actor.actorId,
          contextSnapshot: { issueId: issue.id, issueTitle: issue.title, issueDescription: issue.description, source: "issue.checkout" },
        })
