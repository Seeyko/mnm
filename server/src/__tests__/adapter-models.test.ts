...
import { models as codexFallbackModels } from "@mnm/adapter-codex-local";
import { models as cursorFallbackModels } from "@mnm/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@mnm/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.MNM_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.MNM_OPENCODE_COMMAND = "__mnm_missing_opencode_command__";
